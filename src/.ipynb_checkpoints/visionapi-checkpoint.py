...
from mebocost_test2.visionpy import compute_signatures_anndata
from mebocost_test2 import anndata_accessor
import anndata

global data_accessor; data_accessor = anndata_accessor.AnnDataAccessor()
